            ...
            form.questions.map((q) => {
              ...
              return (
                <div key={q.id} className="detail-item">
                  {q.imageSrc && q.type !== 'image' && (
                    <div className="response-image-block">
                      <img src={q.imageSrc} alt={q.title || 'Gambar'} className="response-image-el" />
                    </div>
                  )}
                  <label className="detail-question" dangerouslySetInnerHTML={{ __html: q.title }} />
                  {q.type === 'image' ? (
                    <div className="detail-answer">
                      {q.imageSrc ? (
                        <img src={q.imageSrc} alt={q.title || 'Gambar'} className="response-image-el" />
                      ) : (
                        <span className="no-answer">Tidak ada gambar</span>
                      )}
                    </div>
                  ) : (
                    <div className="detail-answer">
        ...
        <div className="responses-header">
          <div className="header-left">
            ...
            <div className="header-text">
              ...
              <p className="responses-subtitle" dangerouslySetInnerHTML={{ __html: form?.title || 'Formulir Pendaftaran Acara Tahunan' }} />
            </div>
          </div>
          <button
            type="button"
